jQuery(document).ready(function () {	
	...
	//add widget
	jQuery("#mo_wsfed_client_add_widget").change(function () {
        jQuery("#mo_wsfed_client_add_widget_steps").slideToggle(400);
    });
	
	//add shorcut
	jQuery("#mo_wsfed_client_add_shortcode").change(function () {
        jQuery("#mo_wsfed_client_add_shortcode_steps").slideToggle(400);
    });
