...
class mo_wsfed_client_AESEncryption {
	...
	*/
	public static function decrypt_data($data, $key) {
		...
		return mo_wsfed_client_AESEncryption::pkcs5_unpad(mcrypt_decrypt(MCRYPT_RIJNDAEL_128, $key, $strIn, MCRYPT_MODE_ECB));
	}
